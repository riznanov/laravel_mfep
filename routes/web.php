...
Route::get('login/loginsiswa', 'Login@loginsiswa');
Route::post('login/ceklogin', 'Login@ceklogin');
...
Route::post('daftar/tambah', 'Daftar@tambah');
Route::post('daftar/cek', 'Daftar@cek');
Route::get('daftar/login', 'Daftar@login');

// siswa
Route::group(['namespace' => 'Siswa'],
function()
{
    Route::get('siswa/dasbor', 'Dasbor@index');

    // data siswa
    Route::get('siswa/datasiswa/tambah', 'Datasiswa@tambah');
    Route::get('siswa/datasiswa', 'Datasiswa@index');
    Route::get('siswa/datasiswa/cari', 'Datasiswa@cari');
    Route::get('siswa/datasiswa/status_produk/{par1}', 'Datasiswa@status_produk');
    Route::get('siswa/datasiswa/kategori/{par1}', 'Datasiswa@kategori');
    Route::get('siswa/datasiswa/tambah', 'Datasiswa@tambah');
    Route::get('siswa/datasiswa/tambah_data_ortu', 'Datasiswa@tambah_data_ortu');
    Route::get('siswa/datasiswa/tambah_data_dokumen', 'Datasiswa@tambah_data_dokumen');
    Route::get('siswa/datasiswa/upload_dokumen', 'Datasiswa@upload_dokumen');
    Route::get('siswa/datasiswa/done_datasiswa', 'Datasiswa@done_datasiswa');
    Route::get('siswa/datasiswa/view_datasiswa', 'Datasiswa@view_datasiswa');
    Route::get('siswa/datasiswa/edit/{par1}', 'Datasiswa@edit');
    Route::get('siswa/datasiswa/delete/{par1}', 'Datasiswa@delete');
    Route::post('siswa/datasiswa/tambah_proses', 'Datasiswa@tambah_proses');
    Route::post('siswa/datasiswa/tambah_2_proses', 'Datasiswa@tambah_2_proses');
    Route::post('siswa/datasiswa/tambah_nilai_proses', 'Datasiswa@tambah_nilai_proses');
...
function()
{
    ...
    Route::get('admin/mfep/seleksi_proses', 'Mfep@seleksi_proses');
    Route::get('admin/mfep/pembagian_kelas', 'Mfep@pembagian_kelas');
    Route::get('admin/mfep/cari', 'Mfep@cari');
