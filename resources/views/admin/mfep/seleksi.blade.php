...
<form action="{{ asset('admin/mfep/seleksi_proses') }}" method="get" enctype="multipart/form-data" accept-charset="utf-8">
{{ csrf_field() }}

<div class="form-group row">
	<label class="col-sm-3 control-label text-right">Tahun Ajaran</label>
	<div class="col-sm-3">
...
<div class="form-group row">
	<label class="col-sm-3 control-label text-right">Pilih Data Siswa</label>
                ...
                <tr>
                    <td class="text-center">
                        <div class="icheck-primary">
                          <input type="checkbox" class="icheckbox_flat-blue " name="id_siswa[]" value="<?php echo $datasiswa->id_siswa ?>">
                  ...
                  <td>
                      ...
                      <small>
                        Ijazah : <?php if($datasiswa->ijazah!="") { ?>
                          ...
                          <?php }else{ ?>
                          <img src="{{ asset('public/upload/dokumen siswa/piagam/'.$site->icon) }}" class="img img-thumbnail img-responsive" >
                          <?php } ?>
                      </small>
                  </td>
              </tr>
...
<div class="form-group row">
	...
	<div class="col-sm-9">
		<div class="form-group btn-group pull-right">
			<button type="submit" name="submit" class="btn btn-success "><i class="fa fa-spinner"></i> Proses</button>
