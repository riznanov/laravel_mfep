        ...
        <td>
            ...
            <small>
                <strong>Nilai Rapot</strong>
                  ...
                  <br>Kelas 4 Semester 1 : <strong><?php echo $datasiswa->rapot4b ?></strong>
        ...
        <td>
            ...
            <small>
              Ijazah : <?php if($datasiswa->ijazah!="") { ?>
                ...
                <?php }else{ ?>
                <img src="{{ asset('public/upload/dokumen siswa/ijazah/'.$site->icon) }}" class="img img-thumbnail img-responsive" >
                <?php } ?> 
            </small>
            <br>
            <small>
